...
test("metadata control grids keep explicit two through six column layouts", () => {
  ...
  assert.match(css, /project-status-button\) \{[\s\S]*?grid-template-columns: repeat\(6, minmax\(0, 1fr\)\)/);
});
