...
h1 { font-size:1.7rem; margin-bottom:0; } .preview-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(min(100%,18rem),1fr)); gap:1rem; margin:1rem 0; } .preview-actions { display:flex; flex-wrap:wrap; gap:.5rem; margin:1rem 0; } .callout { padding:1rem; border:1px solid; margin:1rem 0; } .callout-title { font-weight:650; } button { font:inherit; } .fixture-segment-a { width:60%; background:#7aa2f7; } .fixture-segment-b { width:40%; background:#bb9af7; }
